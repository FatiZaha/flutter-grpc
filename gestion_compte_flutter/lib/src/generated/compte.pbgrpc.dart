...
class CompteServiceClient extends $grpc.Client {
  ...
  static final _$deleteCompteById = $grpc.ClientMethod<$0.DeleteCompteByIdRequest, $0.DeleteCompteByIdResponse>(
      '/CompteService/DeleteCompteById',
      ($0.DeleteCompteByIdRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.DeleteCompteByIdResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.DeleteCompteByIdResponse> deleteCompteById($0.DeleteCompteByIdRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteCompteById, request, options: options);
  }
}
...
abstract class CompteServiceBase extends $grpc.Service {
  ...
  CompteServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.DeleteCompteByIdRequest, $0.DeleteCompteByIdResponse>(
        'DeleteCompteById',
        deleteCompteById_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.DeleteCompteByIdRequest.fromBuffer(value),
        ($0.DeleteCompteByIdResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.DeleteCompteByIdResponse> deleteCompteById_Pre($grpc.ServiceCall call, $async.Future<$0.DeleteCompteByIdRequest> request) async {
    return deleteCompteById(call, await request);
  }
  ...
  $async.Future<$0.DeleteCompteByIdResponse> deleteCompteById($grpc.ServiceCall call, $0.DeleteCompteByIdRequest request);
}
