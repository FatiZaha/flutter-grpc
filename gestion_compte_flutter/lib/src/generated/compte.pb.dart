...
class DeleteCompteResult extends $pb.GeneratedMessage {
  factory DeleteCompteResult({
    $core.String? result,
  }) {
    final $result = create();
    if (result != null) {
  ...
  DeleteCompteResult._() : super();
  factory DeleteCompteResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteCompteResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteCompteResult', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeleteCompteResult clone() => DeleteCompteResult()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteCompteResult copyWith(void Function(DeleteCompteResult) updates) => super.copyWith((message) => updates(message as DeleteCompteResult)) as DeleteCompteResult;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DeleteCompteResult create() => DeleteCompteResult._();
  DeleteCompteResult createEmptyInstance() => create();
  static $pb.PbList<DeleteCompteResult> createRepeated() => $pb.PbList<DeleteCompteResult>();
  @$core.pragma('dart2js:noInline')
  static DeleteCompteResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteCompteResult>(create);
  static DeleteCompteResult? _defaultInstance;
...
/// Requête pour obtenir tous les comptes par type
...
class DeleteCompteByIdRequest extends $pb.GeneratedMessage {
  factory DeleteCompteByIdRequest({
    $core.String? id,
  }) {
    final $result = create();
    if (id != null) {
  ...
  DeleteCompteByIdRequest._() : super();
  factory DeleteCompteByIdRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteCompteByIdRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteCompteByIdRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeleteCompteByIdRequest clone() => DeleteCompteByIdRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteCompteByIdRequest copyWith(void Function(DeleteCompteByIdRequest) updates) => super.copyWith((message) => updates(message as DeleteCompteByIdRequest)) as DeleteCompteByIdRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DeleteCompteByIdRequest create() => DeleteCompteByIdRequest._();
  DeleteCompteByIdRequest createEmptyInstance() => create();
  static $pb.PbList<DeleteCompteByIdRequest> createRepeated() => $pb.PbList<DeleteCompteByIdRequest>();
  @$core.pragma('dart2js:noInline')
  static DeleteCompteByIdRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteCompteByIdRequest>(create);
  static DeleteCompteByIdRequest? _defaultInstance;
...
/// Réponse contenant le compte demandé
class DeleteCompteByIdResponse extends $pb.GeneratedMessage {
  factory DeleteCompteByIdResponse({
    DeleteCompteResult? deleted,
  }) {
    final $result = create();
    if (deleted != null) {
  ...
  DeleteCompteByIdResponse._() : super();
  factory DeleteCompteByIdResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteCompteByIdResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteCompteByIdResponse', createEmptyInstance: create)
    ..aOM<DeleteCompteResult>(1, _omitFieldNames ? '' : 'deleted', subBuilder: DeleteCompteResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeleteCompteByIdResponse clone() => DeleteCompteByIdResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteCompteByIdResponse copyWith(void Function(DeleteCompteByIdResponse) updates) => super.copyWith((message) => updates(message as DeleteCompteByIdResponse)) as DeleteCompteByIdResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DeleteCompteByIdResponse create() => DeleteCompteByIdResponse._();
  DeleteCompteByIdResponse createEmptyInstance() => create();
  static $pb.PbList<DeleteCompteByIdResponse> createRepeated() => $pb.PbList<DeleteCompteByIdResponse>();
  @$core.pragma('dart2js:noInline')
  static DeleteCompteByIdResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteCompteByIdResponse>(create);
  static DeleteCompteByIdResponse? _defaultInstance;

  @$pb.TagNumber(1)
  DeleteCompteResult get deleted => $_getN(0);
  @$pb.TagNumber(1)
  set deleted(DeleteCompteResult v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDeleted() => $_has(0);
  @$pb.TagNumber(1)
  void clearDeleted() => clearField(1);
  @$pb.TagNumber(1)
  DeleteCompteResult ensureDeleted() => $_ensure(0);
}
